...
class SkillDetailsModel : ISkillDetailsModel {
    ...
    override fun fetchFeedback(query: FetchFeedbackQuery, listener: ISkillDetailsModel.OnFetchFeedbackFinishedListener) {
        ...
        map.put("model", query.model)
        map.put("group", query.group)
        map.put("language", query.language)
        map.put("skill", query.skill)
        fetchFeedbackResponseCall = ClientBuilder().susiApi.fetchFeedback(map)
